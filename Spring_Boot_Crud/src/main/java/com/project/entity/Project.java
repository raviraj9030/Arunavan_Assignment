...
public class Project {
	...
	public Project(Integer pro_Id, String pro_Name, Double pro_Budget, Integer pro_Teamsize, Integer pro_Duration,
	...
	public String toString() {
		return "Project [pro_Id=" + pro_Id + ", pro_Name=" + pro_Name + ", pro_Budget=" + pro_Budget + ", pro_Teamsize="
				+ pro_Teamsize + ", pro_Duration=" + pro_Duration + ", pro_endDate=" + pro_endDate
