package com.inventory.restClient;
...
public class RestClientDemo {
	...
	public static void main(String[] args) {
		...
		ProductModel productModel = new ProductModel(11, "Charger", 33.00f, 10.00, mf, exp);

		//addProductDetails(productModel);
	...
	private static void getAllProductsDetails() {
		List<ProductModel> productsList = restTemplate.getForObject(URL+ "/getAllproducts", ArrayList.class);
		logger.info("\n\n Rest template fetching the product -->> \n"+productsList+"\n");
	}

	private static void addProductDetails(ProductModel productModel) {
