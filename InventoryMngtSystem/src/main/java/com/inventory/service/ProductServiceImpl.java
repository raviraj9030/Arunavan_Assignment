...
import com.inventory.dao.ProductDaoI;
...
public class ProductServiceImpl implements ProductServiceI {
	...
	public List<ProductModel> listProductDetails() throws ProductException {
		...
		List<ProductModel> listOfProductModels = new ArrayList<>();
		...
		listOfProductModels.sort(Comparator.comparing(ProductModel::getExpiryDate).reversed());
